...
| Login  |10 Escenarios de Login con un pool de datos a-priori| Se digitan campos en email y contraseña y se valida la retroalimentacion|[Ver-generacion](https://github.com/johanCarvajalAndes/poolRepository/wiki/Login)|pool de datos a-priori semi-aleatorio  de escenarios positivos|
